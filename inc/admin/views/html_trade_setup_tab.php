...
if( current_user_can( 'manage_options' ) ) {	
  echo ('   <h3>Trade Types</h3>
   ...
   <div>
		...
		<div class="hform">	
        	<label for="role" style=color:black>Role: </label> <br>     		
        ...
        <div class="hform">   
        <label for="authority" style=color:black>Authority: </label><br>          		
...
// 			$value_label_authority = get_option('cloud_base_authoritys');
		...
		echo ('</select>         </div>
        <div class="hform"> 
        <label for="overrideauthority" style=color:black>Over Ride Authority: </label> <br>      
