                    ...
                    <tr> 
                          <td width="14%" align="center" valign="top" bgcolor="#002B55">
                             	...
                             	<form action="<?php echo admin_url('admin-post.php'); ?>" method="get">
                         	    	<input type="hidden" name="action" value="pdp_training_request">
...
<!-- 
                          <a href="pgc_request_enter_member.php"><img src="<?php echo plugin_dir_url(dirname(dirname(dirname(__FILE__ )))) ?>assets/images/trainingrequest.jpg" width="180" height="36" alt="Request" /></a></td>
 -->
                          ...
                          <td width="14%" align="center" valign="top" bgcolor="#002B55">
                                <form action="<?php echo admin_url('admin-post.php'); ?>" method="get">
                         	    	<input type="hidden" name="action" value="pdp_cfig_schedule">
                         	    	<input type='hidden' name='source_page' value='<?php  the_permalink() ?>' >	 
                         	    	<input type="image" name="submit" src='<?php echo plugin_dir_url(dirname(dirname(dirname(__FILE__ )))) ?>assets/images/displaycfig.jpg'>	 
                      		    </form>                          

<!-- 
                          <a href="pgc_request_vacation_view.php"><img src="<?php echo plugin_dir_url(dirname(dirname(dirname(__FILE__ )))) ?>assets/images/displaycfig.jpg" width="180" height="36" alt="CFIG" /></a></td>
 -->
                          </tr>
                    </table>
        ...
        <tr>
          <td height="189" align="center" valign="top" bgcolor="#003366"><table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#36373A">
			  ...
			  ?>
                 <td bgcolor="<?php echo $color1; ?>"><div align="center"><a href="pgc_request_modify_member.php?request_key=<?php echo $row_Requests['request_key']; ?>"><?php echo ($row_Requests != null) ?  $row_Requests['request_key'] : '' ; ?></a></div></td>
