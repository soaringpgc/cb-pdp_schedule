...
//mysql_select_db($database_PGC, $PGC);
$query_Requests = sprintf("SELECT * FROM pgc_request WHERE request_key = %s", $colname_Requests);
        ...
        <tr>
            <td width="1562" height="56" bgcolor="#4F5359"><div align="center" class="style2">
                <table width="60%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><div align="center" class="style33">CFIG VIEW - PGC STUDENT INSTRUCTION REQUEST</div></td>
                    </tr>
                    <tr>
