...
<table width="900" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#000033">
  ...
  <tr>
    <td height="268" bgcolor="#666666"><table width="900" height="244" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
        <tr>
          <td width="1562" height="40" bgcolor="#4F5359"><div align="center" class="style2">
            <table width="90%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="13%" bgcolor="#0000DD"><div align="center"><a href="pgc_request_vacation_view_cfig_by_cfig.php" class="style57">SORT BY  CFIG </a></div></td>
                <td width="69%"><table width="83%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><div align="center" class="style33">CURRENT &amp; UPCOMING CFIG  OFF DUTY DAYS - BY START DATE </div></td>
                  </tr>
                  <tr>
                    <td><div align="center"></div></td>
                  </tr>
                </table></td>
                <td width="18%" bgcolor="#0000DD"><div align="center" class="style16"><a href="pgc_request_enter_vacay.php" class="style57">ADD CFIG OFF-DUTY ENTRY </a></div></td>
              </tr>
            </table>
          </div></td>
        </tr>
        ...
        <tr>
          <td height="30" bgcolor="#4F5359" class="style16"><div align="center"><a href="pgc_request_list_cfig.php" class="style54">Return to CFIG Request List </a></div></td>
        </tr>
      </table></td>
  </tr>
</table>
